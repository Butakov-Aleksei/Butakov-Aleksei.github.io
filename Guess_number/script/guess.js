...
if (index !== 1) {
    alert(`Вы проиграли....Загаданное число ${randomNumber}. Чтобы попробовать еще раз: обновите страницу. Если надоело: закройте вкладку.`);
} else {
    alert(`Вы угадали! Ваше число ${guess} равно загаданному числу ${randomNumber}. Чтобы попробовать еще раз: обновите страницу. Если надоело: закройте вкладку.`);
}
